...
public class Empleado extends people {
    ...
    public Empleado(int id_puesto, String direccion, String dpi, String fecha_nacimiento, String fecha_inicio_labores, int id, String nombres, String apellidos, String telefono, int genero, String fecha_ingreso) {
    ...
    public DefaultTableModel leer(){
        ...
        try{  
            cn = new Conexion();
            cn.abrir_conexion();
            String query = "SELECT e.id_empleado as id, e.nombres, e.apellidos, e.direccion, e.telefono, e.DPI, e.genero, e.fecha_nacimiento, p.puesto, p.id_puesto, e.fecha_inicio_labores, e.fecha_ingreso FROM empleados as e inner join puestos as p on e.id_puesto = p.id_puesto WHERE e.estado = 'activo';";
    ...
    public int agregar(){
        ...
        try{
            ...
            cn = new Conexion();
            String query= "INSERT INTO empleados(nombres,apellidos,direccion,telefono,dpi,genero,fecha_nacimiento,id_puesto,fecha_inicio_labores,fecha_ingreso, estado) VALUES (?,?,?,?,?,?,?,?,?,?,1);";
            cn.abrir_conexion();
    ...
    public int eliminar(){
        ...
        try{
            PreparedStatement parametro;
            cn = new Conexion();
            String query = "UPDATE empleados SET estado = \"inactivo\" WHERE id_empleado = ?;";
            cn.abrir_conexion();
            parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
